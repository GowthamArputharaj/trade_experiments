...
NUMBER_OF_PIPS_BETWEEN_NEXT_LINE_AND_LAST_CANDLE_CLOSE_PRICE = 50
...
def takeTradeDecision():
	...
	b_exp_sup_res_pft_pts, s_exp_sup_res_pft_pts, sup_res_b_weight, sup_res_s_weight = findExpectedProfitPointsAndWeight(last_candle_close, last_candle_bull_or_bear, asc_sup_res_lines, SUPPORT_RESISTANCE_WEIGHT)
